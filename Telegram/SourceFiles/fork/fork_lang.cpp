...
constexpr auto Keys = std::array{
	...
	"ScheduledMessagesAbout",
	"MuteScheduledNotifications",
	"MuteScheduledNotificationsAbout",
	"PreviewSelfDestructMedia",
	"SelfDestructMediaAbout",
	"ViewSelfDestructMedia",
	...
	"GiftBatchPay",
	"GiftBatchAbout",
	"GiftBatchCommentsAbout",
	"GiftBatchStopAbout",
	"GiftBatchPriceChanged",
	"GiftBatchEnabled",
	"SeeTgProfileGroup",
	"SeeTgConnectionGroup",
	"SeeTgFeaturesAbout",
	"SeeTgGiftsAbout",
	"SeeTgTransfersAbout",
	"SeeTgCommentsAbout",
	...
	"SeeTgEstimateNumber",
	"SeeTgMarketPreviews",
	"SeeTgMarketPreviewsAbout",
	"GiftHistoryPriceLabel",
	"GiftHistoryMarketLabel",
	"GiftInfoTab",
	"GiftHistoryTab",
	"GiftCommentsTab",
	"GiftEventPrice",
	...
	"GiftEventUnknown",
	"SeeTgGiftDetails",
	"SeeTgGiftDetailsAbout",
	"SeeTgEstimateHow",
	"SeeTgEstimateAbout",
	"SeeTgEstimateRange",
	"SeeTgEstimateModel",
	"SeeTgEstimateCollection",
	"SeeTgEstimateUpdated",
	"SeeTgGiftFeature",
	"SeeTgReactionFeature",
	"MessageSeconds",
	"ReactionLike",
	"ReactionDislike",
	"SettingsPrivacy",
